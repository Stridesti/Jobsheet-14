public class BinaryTree27 {
    ...
    public void addRekursif(Mahasiswa27 data) {
        root = addRekursif(root, data);
    }

    private Node27 addRekursif(Node27 current, Mahasiswa27 data) {
        if (current == null) {
    ...
    private void tampilMahasiswaIPKdiAtas(Node27 node, double ipkBatas) {
        if (node != null) {
